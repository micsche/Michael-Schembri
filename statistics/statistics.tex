...
Another segmentation before classiffication technique performed by Nie et al \cite{Nie2018}. The algorithm combines the semantic labelling algorithm of FCN-D16 and Faster RCNN based on VGG-16 into one.  The paper downsizes image by a factor of 2,3,4 and  5 to cater for different ground spatial dimensions.
